...
void calculaFuncao(double *ind, int d, int nivel, double *leader, double *follower, int funcao, double **cost=nullptr, std::vector<int> tollEdges={}, int maxNodes=0, std::map<std::pair<int,int>, double> commodities={});
...
int* sortIndicesByChunks(double *sol, int maxNodes, std::map<std::pair<int,int>, double> commodities);
