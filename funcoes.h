...
void calculaFuncao(double *ind, int d, int nivel, double *leader, double *follower, int funcao, double **cost=nullptr, std::vector<int> tollEdges={}, int maxNodes=0, int startNode=0, int endNode=0);
int getDimensao(int funcao, int nivel, int maxNodes=0, int maxTollEdges=0);
...
bool ehTarifado(int source, int target, std::vector<int> tollEdges, int maxNodes);
